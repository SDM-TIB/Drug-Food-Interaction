...
This work was developed as part of the [SDM-RDFizer](https://github.com/SDM-TIB/SDM-RDFizer) project, within a research workflow for semantic enrichment of biomedical data.
